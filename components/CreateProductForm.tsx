    ...
    return (
        <div className="flex gap-5 lg:gap-10 flex-col lg:flex-row">
            <div className="flex-1">
                <div className={`flex flex-col gap-2 ${files.length == 0 ? "h-full lg:h-screen" : "h-fit"}`}>
                    <div
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <span
                              className="text-muted-foreground pointer-events-none absolute inset-y-0 start-0 flex items-center justify-center ps-3 text-sm">
                            ₹
                          </span>
                                                    <Input
                                                    ...
                                                    />
                                                    <span
                                                        className="border-input bg-background text-muted-foreground z-10 inline-flex items-center rounded-e-md border px-3 text-sm">
                            INR
                          </span>
                                                </div>
                                            </div>
