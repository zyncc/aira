        ...
        <div className="md:basis-1/2 flex flex-col gap-6 container">
            ...
            <div className="space-y-6">
                ...
                <div className="flex md:flex-col justify-center gap-3 pt-2">
                    ...
                    <div
                        className="max-md:border-l max-md:border-primary/40 max-md:pl-3 flex items-center gap-3 text-muted-foreground">
                        <RefreshCw className="h-4 w-4 hidden md:block"/>
                        <span className="text-sm">Easy returns & exchanges</span>
                    </div>
                    {data.order.length > 0 ? <div
                        className="max-md:border-l max-md:border-primary/40 max-md:pl-3 flex items-center gap-3 text-muted-foreground">
                        <ChartLine className="h-4 w-4 hidden md:block"/>
                        <p className="text-sm"><span
                            className={'font-semibold'}>{data.order.length}</span> {data.order.length == 1 ? "Person has" : "People have"} bought
                            this so far</p>
                    </div> : null}
                </div>
                <div>
