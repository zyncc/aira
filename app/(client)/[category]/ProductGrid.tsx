    ...
    return (
        <div className="pb-[50px]">
            ...
            {filteredProducts.length === 0 && (
                <div className="flex flex-col items-center w-screen justify-center py-12 px-4">
                    <div className="relative mb-6">
                        <div
                            className="absolute -inset-1 rounded-full bg-gradient-to-r from-primary/20 to-primary/30 blur-lg"/>
            ...
            <div className="flex lg:container md:container lg:flex-row gap-8 items-start">
                <div
                    className="grid grid-cols-2 md:px-0 md:grid-cols-3 lg:grid-cols-4 gap-1 md:gap-4 w-full md:pb-5 lg:pb-7">
