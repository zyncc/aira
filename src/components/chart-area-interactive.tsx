...
export function ChartAreaInteractive() {
  const [chart, setChart] = React.useState("orders");
  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        ...
        <CardAction>
          <ButtonGroup className="hidden *:data-[slot=toggle-group-item]:!px-4 @[767px]/card:flex">
          ...
          <Select value={chart} onValueChange={(e) => setChart(e!)}>
            <SelectTrigger
            ...
            <SelectContent className="rounded-xl">
              ...
              <SelectItem value="customers" className="rounded-lg">
                Customers
              </SelectItem>
            </SelectContent>
          </Select>
